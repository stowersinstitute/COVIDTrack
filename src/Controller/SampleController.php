...
class SampleController extends AbstractController
{
    ...
    public function list()
    {
        ...
        return $this->render('sample-list.html.twig', [
            'headers' => ['ID', 'Title'],
            'samples' => $samples,
        ]);
    }
    ...
    public function new(Request $request) : Response
    {
        ...
        return $this->render('sample-form.html.twig', ['new' => true, 'form'=>$form->createView()]);
    }
    ...
    public function update(int $id, Request $request) : Response
    {
        ...
        return $this->render('sample-form.html.twig', [
            'new' => false,
