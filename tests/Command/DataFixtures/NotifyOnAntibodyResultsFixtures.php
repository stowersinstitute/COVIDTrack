...
class NotifyOnAntibodyResultsFixtures extends Fixture
{
    ...
    public function load(ObjectManager $em)
    {
        ...
        foreach ($this->getUserData() as $data) {
            ...
            if ($data['notify'] === true) {
                $user->addRole(BaseResultsNotificationCommand::NOTIFY_USERS_WITH_ROLE_ANTIBODY);
            }
...
//                'resultConclusion' => null, Does not yet have a result
            ...
            [
                ...
                'resultReferenceId' => 'AntibodyResult.GroupFive.NegativeResult1',
                'resultConclusion' => SpecimenResultAntibody::CONCLUSION_NEGATIVE,
            ],
            [
                'accessionId' => 'NotifBloodTube0008',
                'tubeType' => Tube::TYPE_BLOOD,
                'collectedAt' => new \DateTimeImmutable('-1 day 9:45am'),
                'participantGroup' => 'GroupFive',
                'wellPlatePosition' => 'A8',
                'resultReferenceId' => 'AntibodyResult.GroupFive.NegativeResult2',
                'resultConclusion' => SpecimenResultAntibody::CONCLUSION_NEGATIVE,
            ],
            [
                'accessionId' => 'NotifBloodTube0009',
                'tubeType' => Tube::TYPE_BLOOD,
                'collectedAt' => new \DateTimeImmutable('-1 day 9:45am'),
                'participantGroup' => 'GroupOne',
                'wellPlatePosition' => 'A9',
                'resultReferenceId' => 'AntibodyResult.GroupOne.NegativeResult',
                'resultConclusion' => SpecimenResultAntibody::CONCLUSION_NEGATIVE,
            ],
        ];
    }
